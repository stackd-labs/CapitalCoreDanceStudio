  ...
  // there is no second version of a price to go stale.
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Little Movers is priced separately from studio class tuition. Drop in for $10 for your first child and $3 for each additional child, buy a Passport of 5 visits for $45 or 10 for $85, or take the monthly membership at $89 — which includes unlimited Little Movers classes plus one Tiny Core class for ages 2–5. Code MOOVE26 takes 30% off a Passport ($31.50 for 5 visits, $59.50 for 10) and 30% off your first month of membership, which we apply to your first invoice. It does not apply to single drop-in classes.',
      },
      {
